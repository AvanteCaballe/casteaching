    ...
    <div id="layout_series_navigation" class="min-h-full" x-data="{ open: false }">
        ...
        <div class="lg:pl-96 flex flex-col overflow-y-auto" style="height: calc(100vh - 65px);">
            ...
            <div class="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:hidden">
                ...
                <button type="button" class="px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500 lg:hidden" x-on:click="open = true;">
                        ...
                        <div class="w-full flex md:ml-0">
                            ...
                            <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                                <div class="absolute inset-y-0 left-0 flex items-center pointer-events-none">
                                    ...
                                    <span class="w-48 truncate" title="{{ $video->serie?->title }}">{{ $video->serie?->title }}</span>                                </div>
                            </div>
                        </div>
                    </div>
